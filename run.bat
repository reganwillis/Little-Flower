...
CALL g++ -Wall src\main.o src\MessageBox.o src\Game.o src\Puzzles.o src\Shapes.o src\UI.o Create-Flower\src\CreateFlower.o src\LittleFlower.o -o little-flower -LC:\SFML-gcc\SFML-2.5.1\lib -lsfml-graphics -lsfml-window -lsfml-system
